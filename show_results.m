...
props(3).Color = [.13 .7 .93]; props(3).LineWidth = 2; props(3).LineStyle = '--';
props(4).Color = [.5 .18 .56]; props(4).LineWidth = 2; props(4).LineStyle = '--';
props(5).Color = [.47 .67 .19]; props(5).LineWidth = 2; props(5).LineStyle = '--';
props(6).Color = [.3 .75 .93]; props(6).LineWidth = 2; props(6).LineStyle = ':';
props(7).Color = [.93 .7 .13]; props(7).LineWidth = 2; props(7).LineStyle = '-.';
props(8).Color = [.0 .0 .0]; props(8).LineWidth = 2; props(8).LineStyle = '-.';
props(9).Color = [.9 .5 .0]; props(9).LineWidth = 1; props(9).LineStyle = '-';
props(10).Color = [.7 .0 .0]; props(10).LineWidth = 1; props(10).LineStyle = '-';
props(11).Color = [.1 .8 .0]; props(11).LineWidth = 1; props(11).LineStyle = '-';
